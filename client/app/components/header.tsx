...
export default function Header({userInfo, center = false}: { userInfo: any, center?: boolean }) {
    return (<div
        className={"w-[95vw] max-w-[70rem] h-14 bg-[#ffffff4d] backdrop-blur-3xl pl-5 pr-5 flex items-center relative rounded-full ml-20 mr-20" + (center ? " left-1/2 -translate-x-1/2" : "")}>
